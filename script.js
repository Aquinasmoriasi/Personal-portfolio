...
<p class="project1-description-p">
...
<div id="divider"></div>
<div id="link-buttons">
<button class="resume" id="live-btn" type="button">See more
  ...
  <button class="resume" id="source-btn" type="button">See source
...
<div id="bg"></div>
  ...
  // landingPage.insertAdjacentHTML("beforebegin", pj1);
